package com.soul.app.customui.tindercard;
...
import com.soul.app.customui.tindercard.*;
...
//              //  onSelectedTop(true, getExitPoint(-objectH), 300);
//               // mFlingListener.onScrollUp(dataObject);
//            }
//            else if(movedBeyondBottomBorder()){
//                //onSelectedTop(false, getExitPoint(-objectH), 300);
//               // mFlingListener.onScrollDown(dataObject);
//            }
            else{
    ...
    private boolean movedBeyondTopBorder() {
        Log.i("Stack View", "aPosY :- " + aPosY + " , halfheight :- " + halfHeight + " topBorder :- " + topBorder());
    ...
    public void onSelectedTop(final boolean isTop,
                              float exitY, long duration) {

        isAnimationRunning = true;
        float exitX;
        if(isTop) {
            exitX  = -objectH - getRotationWidthOffset();
        }
        else {
           exitX = parentHeight + getRotationWidthOffset();
        }
        ...
        this.frame.animate()
                ...
                .rotation(getExitRotationUpDown(isTop));
    }
    ...
    private float getExitPoint(int exitXPoint) {
        ...
        com.soul.app.customui.tindercard.LinearRegression regression = new com.soul.app.customui.tindercard.LinearRegression(x, y);
    ...
    private float getExitRotationUpDown(boolean isLeft) {
    ...
    protected interface FlingListener {
        ...
        void onScrollUp(Object dataObject);

        void onScrollDown(Object dataObject);
    }
