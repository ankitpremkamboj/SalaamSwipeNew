...
public class DrawablePagerIndicator extends View implements com.soul.app.customui.PageIndicator {
    ...
    public DrawablePagerIndicator(Context context, AttributeSet attrs) {
        ...
        drawableSelectedId = a.getResourceId(R.styleable.DrawablePagerIndicator_drawableSelected, R.drawable.page_dot_1);
        drawableDefaultId = a.getResourceId(R.styleable.DrawablePagerIndicator_drawableDefault, R.drawable.page_dot_2);
