...
import com.ak.ta.salaamswipe.retrofit.ApiConstants;
...
public class SettingsActivity extends BaseActivity implements View.OnClickListener {
    ...
    private io.apptik.widget.MultiSlider mAgeSeekBar, mDistanceSeekBar;
    ...
    public void initUi() {
        ...
        mAgeSeekBar = (io.apptik.widget.MultiSlider) findViewById(R.id.age_seekbar);
        mDistanceSeekBar = (io.apptik.widget.MultiSlider) findViewById(R.id.distance_seekbar);
