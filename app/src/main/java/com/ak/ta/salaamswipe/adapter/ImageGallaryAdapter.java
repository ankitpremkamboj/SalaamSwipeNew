...
import com.ak.ta.salaamswipe.customui.RoundedImageView;
...
public class ImageGallaryAdapter extends RecyclerView.Adapter<ImageGallaryAdapter.DataObjectHolder> {
    ...
    @Override
    public ImageGallaryAdapter.DataObjectHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(ImageGallaryAdapter.DataObjectHolder holder, int position) {
