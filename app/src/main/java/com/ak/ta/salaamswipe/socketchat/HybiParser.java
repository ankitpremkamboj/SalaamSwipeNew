package com.ak.ta.salaamswipe.socketchat;
...
public class HybiParser {
    ...
    private byte[] frame(Object data, int opcode, int errorCode) {
        ...
        Lg.e(TAG, "Creating frame for: " + data + " op: " + opcode + " err: " + errorCode);
    ...
    private void emitFrame() throws IOException {
        ...
        if (opcode == OP_CONTINUATION) {
            ...
            if (mFinal) {
                ...
                Lg.e("TAG", " msg in parser :: " + messageText.toString());
                //SimpleJWAndroidClientActivity.obj.showMsg(messageText);
            ...
            if (mFinal) {
                ...
                Lg.e("TAG", " binary msg in parser :: " + payload.toString());
            } else {
                mMode = MODE_BINARY;
                mBuffer.write(payload);
            }
            ...
            Lg.e(TAG, "Got close op! " + code + " " + reason);
