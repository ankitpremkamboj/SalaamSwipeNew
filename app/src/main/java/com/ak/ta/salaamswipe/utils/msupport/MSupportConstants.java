...
package com.ak.ta.salaamswipe.utils.msupport;
...
public class MSupportConstants {
    ...
    public static final String GET_MICROPHONE = Manifest.permission.GET_ACCOUNTS;
    public static final String GET_READSMS = Manifest.permission.READ_SMS;
    public static final String GET_RECEIVE_SMS = Manifest.permission.RECEIVE_SMS;
